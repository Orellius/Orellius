...
I build systems from the bottom up: AI infrastrcture for AI agents, a terminal engine, and an on-device Hebrew voice stack. All three are AGPL-3.0 and readable in full, tests and gates included.
